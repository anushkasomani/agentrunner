...
* always return services(if there are any) before rfp(if there are any) in steps array
* for any agent or api-service their charge represents price per call for them. if it is 0 then they are free to use. 
* for api-services, ignore the budget_usd field.
* use budget
